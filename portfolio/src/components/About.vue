    ...
    <article>
        <section class="about-section">
            ...
            <p class="about-paragraph">
                ...
                I’ve worked on multiple projects, from basic prototypes to advanced systems involving microservices
                architecture and database optimizations.
            </p>
            <p class="about-paragraph">
...
<style scoped>
/* "about" label uses Newsreader (lowercase) */
.about {
...
/* section container: caps width of paragraphs and centers the block */
.about-section {
    max-width: 700px;
    margin: 0 auto;
    padding: 0 1rem;
...
/* underline matches the width of the .about-section (paragraphs) and uses text color */
.about-underline {
    height: 1px;
